...
@include('partials.header')
                    ...
                    <div class="col-lg-6">
                        <div class="story-details pl-50">
                            <div class="story-details-top">
                                <h2>WELCOME TO <span>Abaglobal</span></h2>
                                <p>Abaglobal provide how all this mistaken idea of denouncing pleasure and sing pain was born an will give you a complete account of the system, and expound the actual teachings of the eat explorer. </p>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="banner-wrapper-4 mb-30">
                            <a href="#"><img src="{{asset('radiance/img/banner/37.jpg')}}" alt=""></a>
                    ...
                    <div class="col-lg-4">
                        <div class="banner-wrapper-4 mb-30">
                            <a href="#"><img src="{{asset('radiance/img/banner/21.jpg')}}" alt=""></a>
                    ...
                    <div class="col-lg-4">
                        <div class="banner-wrapper-4 mb-30">
                            <a href="#"><img src="{{asset('radiance/img/banner/22.jpg')}}" alt=""></a>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="goal-wrapper mb-30">
                            <h3>OUR VISSION</h3>
                            <p>Abaglobal provide how all this mistaken idea of denouncing pleasure and sing pain was born an will give you a ete account of the system, and expound the actual teangs of the eat explorer of the truth.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="goal-wrapper mb-30">
        ...
        <div class="choose-area pb-100">
            <div class="container">
                <div class="about-section">
                    ...
                    <p>Abaglobal provide how all this mistaken idea of denouncing pleasure and sing pain was born will give                            you a complete account of the system, and expound the actual </p>
                </div>
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 causes-res">
                                    <div class="choose-wrapper">
                                        <h4>FAST DELIVERY</h4>
                                        <p>Abaglobal provide how all this mistaken dea of denouncing pleasure and sing </p>
                                    </div>
                                    <div class="choose-wrapper">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="choose-banner-wrapper f-right">
                            <img src="{{asset('radiance/img/banner/38.jpg')}}" alt="">
        ...
        <div class="team-area">
            <img src="{{asset('radiance/img/banner/39.jpg')}}" alt="">
        </div>
        <!-- testimonials area start -->
        <div class="testimonials-area pt-100 pb-95 bg-img" style="background-image: url({{asset('radiance/img/bg/7.jpg')}})">
            <div class="container">
                <div class="testimonials-active owl-carousel">
                    <div class="single-testimonial-2 text-center">
                        <img src="{{asset('radiance/img/team/1.png')}}" alt="">
...
sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
                        <img src="{{asset('radiance/img/team/2.png')}}" alt="">
                        <h4>tayeb rayed</h4>
