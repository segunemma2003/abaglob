                ...
                <div class="header-search-cart-login">
                    ...
                    <div class="header-search">
                        <form action="#" class="form-s">
                            <input class='search-l' placeholder="Search What you want" type="text">
                    ...
                    <div class="header-login login-r">
                        <ul>
                            <li><a href="{{URL('/login')}}" class=''>Login</a></li>
                            <li><a href="{{URL('/register')}}" class=''>Reg</a></li>
                        </ul>
                    </div>
                    <div class="header-cart cart-res">
                        <a class="icon-cart" href="#">
                            <i class="ti-shopping-cart"></i>
                            <span class="shop-count pink abgbc">02</span>
                        </a>
